...
export default function MorgAdmin({setLoading, mortgageApplications}: AppointmentFormProps) {
    ...
    const handleModelOpener = async (caseId: string,) => {
        if (!caseId) {
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div
                        ...
                        <table className="min-w-full divide-y divide-primary/20">
                            ...
                            {mortgageApplications.map((m: any) => {
                                const buyerParty = m.parties?.find(
                                    (p: any) => p.role === "BUYER"
                                )
