...
function ValuationTab({ caseId }: OffersTabProps) {
        ...
        <div className="mt-8">
            <div className="grid grid-cols-1 md:grid-cols-10 gap-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white dark:bg-background-dark/50 rounded-lg p-6 flex items-start gap-6">
                                <div className="flex-shrink-0 size-12 rounded-full bg-primary/10 dark:bg-primary/20 flex items-center justify-center text-primary">
                                    <svg
                                        fill="currentColor"
                                        height="28px"
                                        width="28px"
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white dark:bg-background-dark/50 rounded-lg p-6 flex items-start gap-6">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Requested Date</p>
                                    <p className="text-lg font-semibold text-gray-900 dark:text-white">
                ...
                <div className="md:col-span-2">
                    <div className="bg-white dark:bg-background-dark/50 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 p-6">
