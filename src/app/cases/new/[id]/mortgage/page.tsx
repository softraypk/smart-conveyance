...
export default function MortgagePage() {
    ...
    const [mortages, setMortages] = useState<Mortgage[]>([]);
    const [mortageToEdit, setMortageToEdit] = useState<Mortgage | null>(null);
    ...
    const fetchExistingMortage = async () => {
        ...
        try {
            ...
            const formattedMortgages: Mortgage[] = mortageParties.map((b: any) => ({
                id: b.id,
